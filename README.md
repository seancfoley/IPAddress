...
IP address and network manipulations, CIDR, address/subnet operations, iterations, containment checks, longest prefix match, subnetting, and address/subnet data structures, with polymorphic code 
