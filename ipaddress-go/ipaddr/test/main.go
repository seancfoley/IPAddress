...
func main() {
	ipaddr.Test()
	//ipaddr.divFunc(nil)
	seg := ipaddr.IPv6AddressSegment{} //TODO Can we prevent this?  Possibly if we do copying when switching back and forth IPv6, or maybe we can have a default value?
