...
/**
 * IPv4AddressContainmentTrie is an IPAddressCollection of IPv6 addresses backed by an IPv6 address trie.
 * <p>
 ...
 */
public class IPv6AddressContainmentTrie extends IPAddressContainmentTrieBase<IPv6Address, IPv6AddressSeqRange> {
	
	private static final long serialVersionUID = 1L;

	@Override
	public IPv6AddressContainmentTrie clone() {
		return (IPv6AddressContainmentTrie) super.clone();
	}
}
